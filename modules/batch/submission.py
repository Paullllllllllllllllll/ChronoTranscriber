...
from modules.batch.backends import get_batch_backend, BatchRequest, BatchHandle
...
async def submit_batch(
    ...
    try:
        ...
        logger.warning("Could not write early batch_session marker: %s: %s", type(e).__name__, e)
    ...
    try:
        ...
        logger.warning("Could not write submitted batch_session marker: %s: %s", type(e).__name__, e)
