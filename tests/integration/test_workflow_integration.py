...
class TestAutoSelectorIntegration:
    ...
    @pytest.mark.integration
    def test_auto_selector_scans_mixed_directory(self, temp_dir: Path, mock_paths_config: dict[str, Any], mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.integration
    def test_auto_selector_creates_decisions(self, temp_dir: Path, mock_paths_config: dict[str, Any], mock_env_no_api_keys) -> None:
