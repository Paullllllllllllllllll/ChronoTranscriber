...
class TestAnthropicGetModelCapabilities:
    ...
    @pytest.mark.unit
    def test_claude_opus_45_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_sonnet_45_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_haiku_45_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_opus_41_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_opus_4_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_sonnet_4_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_35_sonnet_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_3_opus_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_all_claude_models_support_vision(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_models_do_not_support_image_detail(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_35_haiku_no_structured_output(self) -> None:
    ...
    @pytest.mark.unit
    def test_claude_45_sonnet_supports_structured_output(self) -> None:
    ...
    @pytest.mark.unit
    def test_unknown_claude_model_returns_default_caps(self) -> None:
...
class TestAnthropicProviderInit:
    ...
    @pytest.mark.unit
    def test_thinking_low_effort_maps_to_1024_budget(self) -> None:
    ...
    @pytest.mark.unit
    def test_thinking_high_effort_maps_to_16384_budget(self) -> None:
    ...
    @pytest.mark.unit
    def test_thinking_not_set_without_reasoning_config(self) -> None:
    ...
    @pytest.mark.unit
    def test_adaptive_thinking_for_opus_47(self) -> None:
    ...
    @pytest.mark.unit
    def test_adaptive_thinking_for_opus_46(self) -> None:
    ...
    @pytest.mark.unit
    def test_adaptive_thinking_for_sonnet_46(self) -> None:
