...
class TestConfigureAutoModeSchema:
    ...
    @pytest.mark.unit
    def test_skips_when_no_gpt_decisions(self) -> None:
    ...
    @pytest.mark.unit
    def test_skips_when_decisions_are_non_gpt(self) -> None:
    ...
    @pytest.mark.unit
    def test_prompts_when_gpt_decisions_exist(self) -> None:
    ...
    @pytest.mark.unit
    def test_returns_false_when_context_selection_cancelled(self) -> None:
...
class TestAutoModeCliSchemaSelection:
    ...
    @pytest.mark.unit
    def test_auto_mode_with_schema_argument(self, temp_dir: Path, mock_paths_config: dict[str, Any]) -> None:
    ...
    @pytest.mark.unit
    def test_auto_mode_invalid_schema_raises_error(self, temp_dir: Path, mock_paths_config: dict[str, Any]) -> None:
    ...
    @pytest.mark.unit
    def test_auto_mode_default_schema_when_not_specified(self, temp_dir: Path, mock_paths_config: dict[str, Any]) -> None:
...
class TestAutoModeContextSelection:
    ...
    @pytest.mark.unit
    def test_auto_mode_with_context_argument(self, temp_dir: Path, mock_paths_config: dict[str, Any]) -> None:
