...
class TestAutoSelectorInit:
    ...
    @pytest.mark.unit
    def test_default_config(self, mock_paths_config: dict[str, Any], mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_custom_config(self, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_gpt_available_with_key(self, mock_paths_config: dict[str, Any], mock_env_with_openai_key) -> None:
        """Test GPT availability when API key is set."""
        selector = AutoSelector(mock_paths_config)
        assert selector.gpt_available is True
    
    @pytest.mark.unit
    def test_gpt_not_available_without_key(self, mock_paths_config: dict[str, Any], mock_env_no_api_keys) -> None:
...
class TestAutoSelectorScanDirectory:
    ...
    @pytest.mark.unit
    def test_empty_directory(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_nonexistent_directory(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_finds_pdf_files(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_finds_image_files(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_finds_image_folders(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_finds_epub_files(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_finds_mobi_files(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
...
class TestAutoSelectorDecidePdfMethod:
    ...
    @pytest.mark.unit
    def test_native_for_searchable_pdf(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_tesseract_for_scanned_pdf(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_gpt_fallback_to_tesseract(self, temp_dir: Path, mock_env_no_api_keys) -> None:
...
class TestAutoSelectorDecideImageMethod:
    ...
    @pytest.mark.unit
    def test_tesseract_method(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_gpt_method_with_key(self, temp_dir: Path, mock_env_with_openai_key) -> None:
    ...
    @pytest.mark.unit
    def test_gpt_fallback_without_key(self, temp_dir: Path, mock_env_no_api_keys) -> None:
...
class TestAutoSelectorDecideEpubMethod:
    ...
    @pytest.mark.unit
    def test_always_native(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
...
class TestAutoSelectorCreateDecisions:
    ...
    @pytest.mark.unit
    def test_creates_decisions_for_all_files(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_empty_directory_no_decisions(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
    ...
    @pytest.mark.unit
    def test_image_folder_decision(self, mock_paths_config: dict[str, Any], temp_dir: Path, mock_env_no_api_keys) -> None:
