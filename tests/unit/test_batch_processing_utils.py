...
class TestDiagnoseBatchFailure:
    ...
    def test_failed_batch(self) -> None:
        ...
        with patch('modules.batch.mapping.sdk_to_dict', return_value={"status": "failed"}):
    ...
    def test_cancelled_batch(self) -> None:
        ...
        with patch('modules.batch.mapping.sdk_to_dict', return_value={"status": "cancelled"}):
    ...
    def test_expired_batch(self) -> None:
        ...
        with patch('modules.batch.mapping.sdk_to_dict', return_value={"status": "expired"}):
    ...
    def test_in_progress_batch(self) -> None:
        ...
        with patch('modules.batch.mapping.sdk_to_dict', return_value={"status": "in_progress"}):
