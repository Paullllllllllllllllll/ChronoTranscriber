...
class TestDiagnoseBatchFailure:
    ...
    def test_failed_batch(self) -> None:
        ...
        with patch(
            "modules.batch.mapping.sdk_to_dict", return_value={"status": "failed"}
        ):
    ...
    @pytest.mark.unit
    def test_cancelled_batch(self) -> None:
        ...
        with patch(
            "modules.batch.mapping.sdk_to_dict", return_value={"status": "cancelled"}
        ):
    ...
    @pytest.mark.unit
    def test_expired_batch(self) -> None:
        ...
        with patch(
            "modules.batch.mapping.sdk_to_dict", return_value={"status": "expired"}
        ):
    ...
    @pytest.mark.unit
    def test_in_progress_batch(self) -> None:
        ...
        with patch(
            "modules.batch.mapping.sdk_to_dict", return_value={"status": "in_progress"}
        ):
    ...
    def test_batch_not_found(self) -> None:
        ...
        mock_client = MagicMock()
        mock_client.batches.retrieve.side_effect = Exception(
            "Batch not found in the system"
        )
...
class TestExtractCustomIdMapping:
    ...
    @pytest.mark.unit
    def test_extracts_batch_request_records(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_extracts_image_metadata_records(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_mixed_record_types(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_missing_custom_id(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_missing_image_info(self, temp_dir: Path) -> None:
