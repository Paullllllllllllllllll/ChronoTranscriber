"""Tests for modules.batch.submission."""
...
class TestLoadSystemPrompt:
    ...
    def test_loads_default_prompt(self, mock_root, mock_svc, tmp_path: Path) -> None:
    ...
    @patch("modules.config.service.get_config_service")
    def test_loads_override_prompt(self, mock_svc, tmp_path: Path) -> None:
...
class TestResolveAdditionalContext:
    ...
    @patch("modules.config.context.resolve_context_for_folder")
    def test_hierarchical_context_resolved(self, mock_resolve, tmp_path: Path) -> None:
    ...
    @patch("modules.config.context.resolve_context_for_folder")
    def test_hierarchical_context_none(self, mock_resolve, tmp_path: Path) -> None:
