...
class TestCreateTranscriberParser:
    ...
    @pytest.mark.unit
    def test_parse_gpt_args(self) -> None:
    ...
    @pytest.mark.unit
    def test_parse_model_override_args(self) -> None:
    ...
    @pytest.mark.unit
    def test_parse_auto_mode(self) -> None:
    ...
    @pytest.mark.unit
    def test_parse_files_and_recursive(self) -> None:
    ...
    @pytest.mark.unit
    def test_invalid_type_choice(self) -> None:
    ...
    @pytest.mark.unit
    def test_invalid_method_choice(self) -> None:
...
class TestCreateRepairParser:
    ...
    @pytest.mark.unit
    def test_parse_failure_flags(self) -> None:
    ...
    @pytest.mark.unit
    def test_parse_all_failures(self) -> None:
...
class TestCreateCancelBatchesParser:
    ...
    @pytest.mark.unit
    def test_parse_batch_ids(self) -> None:
...
class TestResolvePath:
    ...
    @pytest.mark.unit
    def test_relative_path_with_base(self, temp_dir: Path) -> None:
...
class TestValidateOutputPath:
    ...
    @pytest.mark.unit
    def test_valid_existing_directory(self, temp_output_dir: Path) -> None:
        """Test validation passes for existing directory."""
    ...
    @pytest.mark.unit
    def test_invalid_file_as_directory(self, sample_text_file) -> None:
...
class TestParseIndices:
    ...
    @pytest.mark.unit
    def test_range_indices(self) -> None:
