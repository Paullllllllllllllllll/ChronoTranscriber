...
class TestIsRepoRoot:
    ...
    @pytest.mark.unit
    def test_detects_config_and_schemas_dirs(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_detects_readme_and_requirements(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_returns_false_for_empty_dir(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_returns_false_for_partial_markers(self, temp_dir: Path) -> None:
...
class TestProjectRoot:
    ...
    @pytest.mark.unit
    def test_project_root_has_config_dir(self) -> None:
    ...
    @pytest.mark.unit
    def test_project_root_has_schemas_dir(self) -> None:
...
class TestConfigLoader:
    ...
    def test_initialization_default_path(self) -> None:
        ...
        from modules.config.config_loader import DEFAULT_CONFIG_PATH, ConfigLoader

        loader = ConfigLoader()
        assert loader.config_path == DEFAULT_CONFIG_PATH

    @pytest.mark.unit
    def test_initialization_custom_path(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_load_yaml_file_success(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_load_yaml_file_missing(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_load_yaml_file_invalid_syntax(self, temp_dir: Path) -> None:
        """Test loading YAML with invalid syntax raises error."""
        from modules.config.config_loader import ConfigLoader

        yaml_file = temp_dir / "invalid.yaml"
        # Use invalid YAML with a tab in indentation, which triggers ScannerError
    ...
    @pytest.mark.unit
    def test_load_yaml_file_empty(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_get_model_config_returns_copy(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_paths_config_caches_result(self) -> None:
    ...
    @pytest.mark.unit
    def test_to_abs_with_absolute_path(self) -> None:
        """Test _to_abs with absolute path."""
        from modules.config.config_loader import PROJECT_ROOT, ConfigLoader
    ...
    @pytest.mark.unit
    def test_to_abs_with_relative_path(self) -> None:
    ...
    @pytest.mark.unit
    def test_to_abs_with_none(self) -> None:
    ...
    @pytest.mark.unit
    def test_to_abs_with_empty_string(self) -> None:
...
class TestNormalizePathsConfig:
    ...
    @pytest.mark.unit
    def test_normalizes_general_paths(self) -> None:
    ...
    @pytest.mark.unit
    def test_preserves_non_path_values(self) -> None:
