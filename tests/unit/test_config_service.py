...
class TestConfigServiceSingleton:
    ...
    @pytest.mark.unit
    def test_get_config_service_returns_singleton(self) -> None:
...
class TestConfigServiceMethods:
    ...
    @pytest.mark.unit
    def test_get_model_config_returns_dict(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_paths_config_returns_dict(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_concurrency_config_returns_dict(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_image_processing_config_returns_dict(self) -> None:
...
class TestConvenienceFunctions:
    ...
    @pytest.mark.unit
    def test_get_model_config_function(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_paths_config_function(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_concurrency_config_function(self) -> None:
    ...
    @pytest.mark.unit
    def test_get_image_processing_config_function(self) -> None:
