...
class TestResolveContext:
    ...
    @pytest.mark.unit
    def test_file_specific_found(self, temp_dir: Path) -> None:
        """File-specific context is returned when present."""
        from modules.config.context import _resolve_context
    ...
    @pytest.mark.unit
    def test_folder_specific_found(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_file_wins_over_folder(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_folder_wins_over_general(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_returns_none_when_no_context(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_empty_file_skipped(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_directory_input_folder_specific(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_no_input_path_uses_general(self, temp_dir: Path) -> None:
...
class TestResolveContextForFile:
    ...
    @pytest.mark.unit
    def test_finds_file_specific_context(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_finds_folder_specific_context(self, temp_dir: Path) -> None:
...
class TestResolveContextForImage:
    ...
    @pytest.mark.unit
    def test_finds_image_specific_context(self, temp_dir: Path) -> None:
        """Image-specific context uses _transcr_context suffix."""
        from modules.config.context import resolve_context_for_image
    ...
    @pytest.mark.unit
    def test_finds_folder_context_for_image(self, temp_dir: Path) -> None:
...
class TestReadAndValidateContext:
    ...
    @pytest.mark.unit
    def test_reads_valid_context(self, temp_dir: Path) -> None:
        """Valid file returns stripped content."""
        from modules.config.context import _read_and_validate_context
    ...
    @pytest.mark.unit
    def test_returns_none_for_whitespace_only(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_strips_whitespace(self, temp_dir: Path) -> None:
...
class TestLoadContextFromPath:
    ...
    @pytest.mark.unit
    def test_loads_existing_context(self, temp_dir: Path) -> None:
