...
class TestGoogleGetModelCapabilities:
    ...
    @pytest.mark.unit
    def test_gemini_3_flash_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_3_pro_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_25_pro_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_25_flash_reasoning_controls_disabled(self) -> None:
        """Gemini 2.5 Flash uses thinking implicitly but does NOT accept an
        explicit thinking_level via the SDK (the API returns
        INVALID_ARGUMENT "Thinking level is not supported for this
        model."). The registry records this by disabling
        reasoning_effort for this family.
        """
        from modules.config.capabilities import detect_capabilities
    ...
    @pytest.mark.unit
    def test_gemini_20_flash_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_15_pro_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_15_flash_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_all_gemini_models_support_vision(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_models_support_media_resolution(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_models_do_not_support_image_detail(self) -> None:
    ...
    @pytest.mark.unit
    def test_unknown_gemini_model_returns_default_caps(self) -> None:
    ...
    @pytest.mark.unit
    def test_gemini_25_pro_has_large_context(self) -> None:
...
class TestGoogleProviderInit:
    ...
    @pytest.mark.unit
    def test_thinking_level_not_set_for_non_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_thinking_level_not_set_without_reasoning_config(self) -> None:
