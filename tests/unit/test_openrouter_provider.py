...
class TestOpenRouterGetModelCapabilities:
    ...
    @pytest.mark.unit
    def test_deepseek_r1_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_deepseek_v3_is_not_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_openai_gpt5_via_openrouter_is_reasoning(self) -> None:
    ...
    @pytest.mark.unit
    def test_openai_gpt4o_via_openrouter_is_not_reasoning(self) -> None:
    ...
    @pytest.mark.unit
    def test_anthropic_claude_45_via_openrouter_is_reasoning(self) -> None:
    ...
    @pytest.mark.unit
    def test_anthropic_claude_35_via_openrouter_returns_caps(self) -> None:
    ...
    @pytest.mark.unit
    def test_google_gemini_25_via_openrouter_is_reasoning(self) -> None:
    ...
    @pytest.mark.unit
    def test_google_gemini_20_via_openrouter_is_not_reasoning(self) -> None:
    ...
    @pytest.mark.unit
    def test_meta_llama_via_openrouter(self) -> None:
    ...
    @pytest.mark.unit
    def test_mistral_pixtral_via_openrouter(self) -> None:
    ...
    @pytest.mark.unit
    def test_unknown_model_returns_default_caps(self) -> None:
    ...
    @pytest.mark.unit
    def test_gpt_oss_is_reasoning_model(self) -> None:
    ...
    @pytest.mark.unit
    def test_all_vision_models_support_vision(self) -> None:
...
class TestEffortToRatio:
    ...
    def test_none_effort(self) -> None:
...
class TestComputeOpenrouterReasoningMaxTokens:
    ...
    def test_minimum_budget_is_1024(self) -> None:
        result = _compute_openrouter_reasoning_max_tokens(
            max_tokens=2000, effort="minimal"
        )
        assert result >= 1024

    def test_budget_capped_at_32000(self) -> None:
        result = _compute_openrouter_reasoning_max_tokens(
...
class TestOpenRouterProviderReasoningConfig:
    ...
    def test_anthropic_model_maps_effort_to_max_tokens(
        self, mock_caps: MagicMock, mock_chat: MagicMock, mock_retries: MagicMock
    ) -> None:
        caps = MagicMock()
