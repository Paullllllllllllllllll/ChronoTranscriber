...
class TestResolveOutputPath:
    ...
    @pytest.mark.unit
    def test_unknown_format_defaults_to_txt(self, tmp_path: Path) -> None:
...
class TestWriteTxt:
    ...
    @pytest.mark.unit
    def test_normal_pages_no_headers(self, tmp_path: Path) -> None:
        """Normal transcription text should have no image/page headers."""
        pages = [
            _make_normal_page("First page text."),
            _make_normal_page("Second page text.", 2, "page_002.jpg"),
        ]
        path = write_transcription_output(
            pages, tmp_path / "out.txt", "txt", postprocess=False
        )
    ...
    @pytest.mark.unit
    def test_failure_page_gets_header(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_mixed_normal_and_failure_pages(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_empty_pages_list(self, tmp_path: Path) -> None:
        """Empty pages list produces an empty file."""
        path = write_transcription_output(
            [], tmp_path / "out.txt", "txt", postprocess=False
        )
...
class TestWriteMd:
    ...
    @pytest.mark.unit
    def test_normal_pages_no_programmatic_headers(self, tmp_path: Path) -> None:
        ...
        path = write_transcription_output(
            pages, tmp_path / "out.md", "md", postprocess=False
        )
        content = path.read_text(encoding="utf-8")
    ...
    @pytest.mark.unit
    def test_page_number_tags_preserved(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_failure_page_gets_header_in_md(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_pages_separated_by_double_newline(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_no_header_when_llm_omits_page_number_tag(self, tmp_path: Path) -> None:
        """Even if the LLM omits <page_number>, no programmatic header should appear."""
        pages = [
            _make_normal_page(
                "Just plain text without any page tag.", 10, "img_010.jpg"
            )
        ]
        path = write_transcription_output(
            pages, tmp_path / "out.md", "md", postprocess=False
    ...
    def test_empty_pages_list(self, tmp_path: Path) -> None:
        """Empty pages list produces an empty file."""
        path = write_transcription_output(
            [], tmp_path / "out.md", "md", postprocess=False
        )
        assert path.read_text(encoding="utf-8") == ""
...
class TestWriteJson:
    ...
    @pytest.mark.unit
    def test_writes_structured_records(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_preserves_page_metadata(self, tmp_path: Path) -> None:
...
class TestWriteTranscriptionOutput:
    ...
    @pytest.mark.unit
    def test_dispatches_to_txt(self, tmp_path: Path) -> None:
        pages = [_make_normal_page()]
        path = write_transcription_output(
            pages, tmp_path / "out.xyz", "txt", postprocess=False
        )
        assert path.suffix == ".txt"
        assert path.exists()

    @pytest.mark.unit
    def test_dispatches_to_md(self, tmp_path: Path) -> None:
        pages = [_make_normal_page()]
        path = write_transcription_output(
            pages, tmp_path / "out.xyz", "md", postprocess=False
        )
    ...
    @pytest.mark.unit
    def test_unknown_format_falls_back_to_txt(self, tmp_path: Path) -> None:
        pages = [_make_normal_page()]
        path = write_transcription_output(
            pages, tmp_path / "out.xyz", "csv", postprocess=False
        )
        assert path.suffix == ".txt"
        assert path.exists()
    ...
    @pytest.mark.unit
    def test_all_formats_consistent_for_normal_text(self, tmp_path: Path) -> None:
        ...
        txt_path = write_transcription_output(
            pages, tmp_path / "out.txt", "txt", postprocess=False
        )
        md_path = write_transcription_output(
            pages, tmp_path / "out.md", "md", postprocess=False
        )
    ...
    @pytest.mark.unit
    def test_all_formats_consistent_for_failures(self, tmp_path: Path) -> None:
