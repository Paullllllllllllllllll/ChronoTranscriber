...
from modules.documents.page_range import PageRange, parse_page_range
...
class TestParsePageRange:
    ...
    @pytest.mark.unit
    def test_bare_integer_first_n(self) -> None:
    ...
    @pytest.mark.unit
    def test_explicit_first_n(self) -> None:
        pr = parse_page_range("first:10")
        assert pr.first_n == 10

    @pytest.mark.unit
    def test_explicit_first_n_with_spaces(self) -> None:
    ...
    @pytest.mark.unit
    def test_last_n_case_insensitive(self) -> None:
    ...
    @pytest.mark.unit
    def test_range_both_sides(self) -> None:
    ...
    @pytest.mark.unit
    def test_compound_with_overlap(self) -> None:
        pr = parse_page_range("1-5,3-8")
        # Merged: (0,7)
        assert pr.spans == ((0, 7),)

    @pytest.mark.unit
    def test_compound_adjacent(self) -> None:
    ...
    @pytest.mark.unit
    def test_bare_dash_raises(self) -> None:
...
class TestPageRangeResolve:
    ...
    @pytest.mark.unit
    def test_first_n_within_bounds(self) -> None:
        pr = parse_page_range("5")
        assert pr.resolve(20) == [0, 1, 2, 3, 4]

    @pytest.mark.unit
    def test_first_n_exceeds_total(self) -> None:
        pr = parse_page_range("50")
        assert pr.resolve(10) == list(range(10))

    @pytest.mark.unit
    def test_last_n_within_bounds(self) -> None:
        pr = parse_page_range("last:3")
        assert pr.resolve(10) == [7, 8, 9]

    @pytest.mark.unit
    def test_last_n_exceeds_total(self) -> None:
    ...
    @pytest.mark.unit
    def test_compound_resolve(self) -> None:
        pr = parse_page_range("1,3,5-8")
...
class TestPageRangeDescribe:
    ...
    @pytest.mark.unit
    def test_first_n_describe(self) -> None:
        pr = parse_page_range("first:5")
        assert pr.describe() == "first 5 page(s)"

    @pytest.mark.unit
    def test_last_n_describe(self) -> None:
        pr = parse_page_range("last:3")
    ...
    @pytest.mark.unit
    def test_compound_describe(self) -> None:
        pr = parse_page_range("1,3,5-8")
        assert pr.describe() == "pages 1,3,5-8"

    @pytest.mark.unit
    def test_single_page_describe(self) -> None:
        pr = parse_page_range("3-3")
...
class TestPageRangeIsEmptySpec:
    ...
    @pytest.mark.unit
    def test_first_n_not_empty(self) -> None:
        pr = parse_page_range("5")
        assert pr.is_empty_spec() is False

    @pytest.mark.unit
    def test_default_page_range_empty(self) -> None:
        pr = PageRange()
