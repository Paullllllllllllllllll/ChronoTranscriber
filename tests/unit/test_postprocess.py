...
class TestFixHyphenation:
    ...
    @pytest.mark.unit
    def test_merges_lowercase_hyphenation(self) -> None:
    ...
    @pytest.mark.unit
    def test_preserves_proper_names(self) -> None:
...
class TestNormalizeSpacing:
    ...
    @pytest.mark.unit
    def test_custom_tab_size(self) -> None:
...
class TestShouldWrapLine:
    ...
    @pytest.mark.unit
    def test_empty_line_no_wrap(self) -> None:
        """Test that empty lines are not wrapped."""
        assert should_wrap_line("") is False
        assert should_wrap_line("   ") is False

    @pytest.mark.unit
    def test_markdown_heading_no_wrap(self) -> None:
    ...
    @pytest.mark.unit
    def test_normal_text_wraps(self) -> None:
...
class TestComputeAutoWrapWidth:
    ...
    @pytest.mark.unit
    def test_returns_default_for_sparse_text(self) -> None:
...
class TestWrapLongLines:
    ...
    @pytest.mark.unit
    def test_zero_width_no_change(self) -> None:
...
class TestPostprocessFile:
    ...
    @pytest.mark.unit
    def test_requires_output_or_inplace(self, sample_text_file: Path) -> None:
    ...
    @pytest.mark.unit
    def test_in_place_modification(self, temp_dir: Path) -> None:
    ...
    @pytest.mark.unit
    def test_output_to_different_file(self, temp_dir: Path) -> None:
