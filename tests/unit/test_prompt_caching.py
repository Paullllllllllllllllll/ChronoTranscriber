...
class TestBatchResultItemCacheFields:
    ...
    @pytest.mark.unit
    def test_defaults_are_zero(self):
        from modules.llm.batch.backends.base import BatchResultItem
...
class TestCacheTokenExtraction:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_anthropic_cache_creation_tokens(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_openai_cache_tokens_from_prompt_details(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_no_cache_tokens_when_absent(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_cache_tokens_from_usage_metadata_fallback(self):
...
class TestAnthropicProviderCacheControl:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_cache_control_1h_ttl(self):
...
class TestOpenAIProviderCacheRetention:
    ...
    @pytest.mark.unit
    def test_retention_passed_to_chat_openai(self):
...
class TestOpenRouterProviderCacheControl:
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_cache_control_for_claude_model(self):
    ...
    @pytest.mark.unit
    @pytest.mark.asyncio
    async def test_no_cache_control_for_non_claude_model(self):
...
class TestTranscriberResultToDict:
    ...
    @pytest.mark.unit
    def test_cache_tokens_included_in_usage(self):
        from modules.llm.providers.base import TranscriptionResult
    ...
    @pytest.mark.unit
    def test_no_cache_fields_when_zero(self):
        from modules.llm.providers.base import TranscriptionResult
...
class TestTranscriberSessionAccumulators:
    ...
    @pytest.mark.unit
    def test_accumulators_increment(self):
        from modules.llm.providers.base import TranscriptionResult
        from modules.llm.transcriber import LangChainTranscriber
...
class TestAnthropicBatchBackendCacheControl:
    ...
    @pytest.mark.unit
    def test_system_param_has_cache_control_when_enabled(self):
        ...
        with patch("modules.llm.batch.backends.anthropic_backend.get_config_service") as mock_cs:
            mock_cs.return_value.get_prompt_caching_config.return_value = caching_cfg
    ...
    @pytest.mark.unit
    def test_system_param_is_string_when_disabled(self):
        from modules.llm.batch.backends.anthropic_backend import AnthropicBatchBackend
        from modules.llm.batch.backends.base import BatchRequest
...
class TestOpenAIBatchBackendCacheExtraction:
    ...
    @pytest.mark.unit
    def test_cached_tokens_extracted_from_prompt_details(self):
...
class TestBatchingPromptCacheRetention:
    ...
    @pytest.mark.unit
    def test_retention_added_when_configured(self):
        from modules.llm.batch.batching import _build_responses_body_for_image

        with patch("modules.llm.batch.batching.get_config_service") as mock_cs:
    ...
    @pytest.mark.unit
    def test_retention_not_added_when_null(self):
        from modules.llm.batch.batching import _build_responses_body_for_image
    ...
    @pytest.mark.unit
    def test_retention_not_added_when_disabled(self):
        from modules.llm.batch.batching import _build_responses_body_for_image
