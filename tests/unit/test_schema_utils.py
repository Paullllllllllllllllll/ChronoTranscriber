...
class TestListSchemaOptions:
    ...
    @pytest.mark.unit
    def test_finds_json_schemas(self) -> None:
...
class TestFindSchemaPathByName:
    ...
    @pytest.mark.unit
    def test_finds_existing_schema(self) -> None:
...
class TestSchemaDiscovery:
    ...
    @pytest.mark.unit
    def test_schema_options_are_tuples(self) -> None:
    ...
    @pytest.mark.unit
    def test_schema_paths_exist(self) -> None:
