...
class TestLangChainTranscriberInit:
    ...
    @pytest.mark.unit
    def test_model_name_loaded_from_config(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_temperature_loaded_from_config(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_max_tokens_loaded_from_config(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_reasoning_config_forwarded(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_reasoning_config_absent_when_not_configured(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_service_tier_loaded_from_concurrency_config(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_service_tier_absent_when_not_configured(self, tmp_path: Path) -> None:
...
class TestLangChainTranscriberTextVerbosity:
    ...
    @pytest.mark.unit
    def test_text_config_forwarded_when_configured(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_text_config_not_forwarded_when_empty(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_all_verbosity_levels_forwarded(self, tmp_path: Path) -> None:
...
class TestLangChainTranscriberRuntimeOverrides:
    ...
    @pytest.mark.unit
    def test_max_output_tokens_runtime_override_wins(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_reasoning_config_runtime_override_wins(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_text_config_runtime_override_wins(self, tmp_path: Path) -> None:
