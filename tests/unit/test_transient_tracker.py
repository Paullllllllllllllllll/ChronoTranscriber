...
class TestTransientFileTracker:
    ...
    @pytest.mark.unit
    def test_mark_preprocessed_complete_removes_from_tracking(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_deletes_jsonl_when_not_retained(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_preserves_jsonl_when_retained(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_deletes_preprocessed_folder_when_not_kept(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_preserves_preprocessed_folder_when_kept(self, tmp_path: Path) -> None:
...
class TestTransientTrackerIntegration:
    ...
    def test_workflow_manager_initializes_tracker(self) -> None:
        ...
        from modules.transcribe.manager import WorkflowManager, TransientFileTracker
