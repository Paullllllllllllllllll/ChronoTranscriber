...
class TestTransientFileTracker:
    ...
    @pytest.mark.unit
    def test_register_jsonl(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_register_preprocessed_folder(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_mark_jsonl_complete_removes_from_tracking(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_mark_preprocessed_complete_removes_from_tracking(
        self, tmp_path: Path
    ) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_deletes_jsonl_when_not_retained(
        self, tmp_path: Path
    ) -> None:
        """Test cleanup_pending deletes JSONL when retain_temporary_jsonl is False."""
        from modules.transcribe.manager import TransientFileTracker
    ...
    @pytest.mark.unit
    def test_cleanup_pending_preserves_jsonl_when_retained(
        self, tmp_path: Path
    ) -> None:
        """Test cleanup_pending preserves JSONL when retain_temporary_jsonl is True."""
        from modules.transcribe.manager import TransientFileTracker
    ...
    @pytest.mark.unit
    def test_cleanup_pending_preserves_gpt_batch_jsonl(self, tmp_path: Path) -> None:
    ...
    @pytest.mark.unit
    def test_cleanup_pending_deletes_preprocessed_folder_when_not_kept(
        self, tmp_path: Path
    ) -> None:
        """Test cleanup_pending deletes preprocessed folder when
        keep_preprocessed_images is False."""
        from modules.transcribe.manager import TransientFileTracker

        tracker = TransientFileTracker()
        tracker.configure(
            {"keep_preprocessed_images": False}, use_batch_processing=False
        )
    ...
    @pytest.mark.unit
    def test_cleanup_pending_preserves_preprocessed_folder_when_kept(
        self, tmp_path: Path
    ) -> None:
        """Test cleanup_pending preserves preprocessed folder when
        keep_preprocessed_images is True."""
        from modules.transcribe.manager import TransientFileTracker

        tracker = TransientFileTracker()
        tracker.configure(
            {"keep_preprocessed_images": True}, use_batch_processing=False
        )
    ...
    @pytest.mark.unit
    def test_clear_removes_all_tracking_without_cleanup(self, tmp_path: Path) -> None:
        """Test that clear() removes tracking without deleting files."""
        from modules.transcribe.manager import TransientFileTracker

        tracker = TransientFileTracker()
        tracker.configure(
            {"retain_temporary_jsonl": False, "keep_preprocessed_images": False}
        )
    ...
    @pytest.mark.unit
    def test_cleanup_handles_missing_files_gracefully(self, tmp_path: Path) -> None:
...
class TestTransientTrackerIntegration:
    ...
    def test_tracker_configured_with_processing_settings(self) -> None:
        ...
        assert (
            wm._transient_tracker._processing_settings.get("retain_temporary_jsonl")
            is False
        )
        assert (
            wm._transient_tracker._processing_settings.get("keep_preprocessed_images")
            is False
        )
...
class TestKeyboardInterruptCleanup:
    ...
    def test_keyboard_interrupt_calls_cleanup_pending(self) -> None:
        ...
        with (
            patch.object(wm, "process_single_image_folder", side_effect=_raise),
